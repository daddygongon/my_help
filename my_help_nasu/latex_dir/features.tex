...
\end{verbatim}\end{quote}
\section{全てのhelp画面の表示}\begin{lstlisting}[style=]
...
\section{過去にバックアップしてあるitemのリストの表示}\begin{lstlisting}[style=]
#language: ja
...
\section{helpコマンドの追加や削除，編集をするファイルの開示}\begin{lstlisting}[style=]
# language: ja
#--edit
...
\section{specific\_helpのitemの消去}\begin{lstlisting}[style=]
#language: ja
...
\section{itemのバックアップ}\begin{lstlisting}[style=]
#language: ja
...
\section{hikiへのformatの変更}\begin{lstlisting}[style=]
# language: ja
...
\section{todoの更新}\begin{lstlisting}[style=]
# language: ja
